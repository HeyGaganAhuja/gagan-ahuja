    ...
    <section className="py-24 bg-zinc-900 text-zinc-100">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6 text-white animate-fade-in">Book a Meeting With Us</h2>
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="px-8 py-6 text-base bg-transparent border-zinc-400 text-white hover:bg-zinc-800 hover-scale animate-fade-in" 
