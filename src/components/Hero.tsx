...
const Hero = () => {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none">
      {/* Spline 3D Rocket Background */}
      <iframe 
        src='https://my.spline.design/rocket-a1e953d5affdd5cdfa3d55f685588701/' 
        className="absolute inset-0 w-full h-full opacity-20"
        frameBorder='0'
      ></iframe>

      <section className="absolute inset-0 pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden dotted-pattern grid-pattern">
